...
public class Java_answer_checker : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (correct_answer_count == 5)
        {
            ...
            {
                Next_Stage_World.text = "Success Java Stage Clear";
            ...
            if (Next_Stage_World_name == "Java World 2" && Quest_Name_var == "Java World 1 Quest")
            {
                java_world_1();
            }

            else if (Next_Stage_World_name == "Java World 3" && Quest_Name_var == "Java World 2 Quest")
            {
                java_world_2();
            }

            else if (Next_Stage_World_name == "Php World 1" && Quest_Name_var == "Java World 3 Quest")
            {
                java_world_3();
            }
